...
# Web page links
REGISTER_PAGE='http://www.ptgrey.com/support/softwarereg.asp?text=ProductName+Linux+ARM+Spinnaker+$MAJOR_VERSION%2E$MINOR_VERSION+$RELEASE_TYPE_TEXT+$RELEASE_BUILD+%0D%0AProductVersion+$MAJOR_VERSION%2E$MINOR_VERSION%2E$RELEASE_TYPE%2E$RELEASE_BUILD%0D%0A'
